...
impl Constellation {
    fn from_constellation_t(value: signal_c::constellation_t) -> Option<Constellation> {
        match value {
            ...
            signal_c::constellation_e_CONSTELLATION_INVALID | signal_c::constellation_e_CONSTELLATION_COUNT | _ => { None }
        }
    }
...
impl Code {
    ...
    pub fn to_string(&self) -> Result<String, Utf8Error> {
        let c_str = unsafe { ffi::CStr::from_ptr(signal_c::code_to_string(*self as signal_c::code_t)) };

        Ok(c_str.to_str()?.to_owned())
    }

    pub fn to_constellation(&self) -> Constellation {
        Constellation::from_constellation_t(unsafe { signal_c::code_to_constellation(*self as signal_c::code_t) }).unwrap()
    }
...
impl GnssSignal {
    ...
    pub fn to_constellation(&self) -> Constellation {
        Constellation::from_constellation_t(unsafe { signal_c::sid_to_constellation(self.0) }).unwrap()
    }
...
mod tests {
    ...
    fn signal_to_constellation() {
        assert_eq!(GnssSignal::new(0, Code::GpsL1ca).to_constellation(), Constellation::Gps);
        assert_eq!(GnssSignal::new(0, Code::GpsL2cm).to_constellation(), Constellation::Gps);
        assert_eq!(GnssSignal::new(0, Code::SbasL1ca).to_constellation(), Constellation::Sbas);
        assert_eq!(GnssSignal::new(0, Code::GloL1of).to_constellation(), Constellation::Glo);
        assert_eq!(GnssSignal::new(0, Code::GloL2of).to_constellation(), Constellation::Glo);
        assert_eq!(GnssSignal::new(0, Code::GpsL1p).to_constellation(), Constellation::Gps);
        assert_eq!(GnssSignal::new(0, Code::GpsL2p).to_constellation(), Constellation::Gps);
        assert_eq!(GnssSignal::new(0, Code::GpsL2cl).to_constellation(), Constellation::Gps);
        assert_eq!(GnssSignal::new(0, Code::GpsL2cx).to_constellation(), Constellation::Gps);
        assert_eq!(GnssSignal::new(0, Code::GpsL5i).to_constellation(), Constellation::Gps);
        assert_eq!(GnssSignal::new(0, Code::GpsL5q).to_constellation(), Constellation::Gps);
        assert_eq!(GnssSignal::new(0, Code::GpsL5x).to_constellation(), Constellation::Gps);
        assert_eq!(GnssSignal::new(0, Code::Bds2B1).to_constellation(), Constellation::Bds);
        assert_eq!(GnssSignal::new(0, Code::Bds2B2).to_constellation(), Constellation::Bds);
        assert_eq!(GnssSignal::new(0, Code::GalE1b).to_constellation(), Constellation::Gal);
        assert_eq!(GnssSignal::new(0, Code::GalE1c).to_constellation(), Constellation::Gal);
        assert_eq!(GnssSignal::new(0, Code::GalE1x).to_constellation(), Constellation::Gal);
        assert_eq!(GnssSignal::new(0, Code::GalE6b).to_constellation(), Constellation::Gal);
        assert_eq!(GnssSignal::new(0, Code::GalE6c).to_constellation(), Constellation::Gal);
        assert_eq!(GnssSignal::new(0, Code::GalE6x).to_constellation(), Constellation::Gal);
        assert_eq!(GnssSignal::new(0, Code::GalE7i).to_constellation(), Constellation::Gal);
        assert_eq!(GnssSignal::new(0, Code::GalE7q).to_constellation(), Constellation::Gal);
        assert_eq!(GnssSignal::new(0, Code::GalE7x).to_constellation(), Constellation::Gal);
        assert_eq!(GnssSignal::new(0, Code::GalE8i).to_constellation(), Constellation::Gal);
        assert_eq!(GnssSignal::new(0, Code::GalE8q).to_constellation(), Constellation::Gal);
        assert_eq!(GnssSignal::new(0, Code::GalE8x).to_constellation(), Constellation::Gal);
        assert_eq!(GnssSignal::new(0, Code::GalE5i).to_constellation(), Constellation::Gal);
        assert_eq!(GnssSignal::new(0, Code::GalE5q).to_constellation(), Constellation::Gal);
        assert_eq!(GnssSignal::new(0, Code::GalE5x).to_constellation(), Constellation::Gal);
        assert_eq!(GnssSignal::new(0, Code::GloL1p).to_constellation(), Constellation::Glo);
        assert_eq!(GnssSignal::new(0, Code::GloL2p).to_constellation(), Constellation::Glo);
        assert_eq!(GnssSignal::new(0, Code::QzsL1ca).to_constellation(), Constellation::Qzs);
        assert_eq!(GnssSignal::new(0, Code::QzsL1ci).to_constellation(), Constellation::Qzs);
        assert_eq!(GnssSignal::new(0, Code::QzsL1cq).to_constellation(), Constellation::Qzs);
        assert_eq!(GnssSignal::new(0, Code::QzsL1cx).to_constellation(), Constellation::Qzs);
        assert_eq!(GnssSignal::new(0, Code::QzsL2cm).to_constellation(), Constellation::Qzs);
        assert_eq!(GnssSignal::new(0, Code::QzsL2cl).to_constellation(), Constellation::Qzs);
        assert_eq!(GnssSignal::new(0, Code::QzsL2cx).to_constellation(), Constellation::Qzs);
        assert_eq!(GnssSignal::new(0, Code::QzsL5i).to_constellation(), Constellation::Qzs);
        assert_eq!(GnssSignal::new(0, Code::QzsL5q).to_constellation(), Constellation::Qzs);
        assert_eq!(GnssSignal::new(0, Code::QzsL5x).to_constellation(), Constellation::Qzs);
        assert_eq!(GnssSignal::new(0, Code::SbasL5i).to_constellation(), Constellation::Sbas);
        assert_eq!(GnssSignal::new(0, Code::SbasL5q).to_constellation(), Constellation::Sbas);
        assert_eq!(GnssSignal::new(0, Code::SbasL5x).to_constellation(), Constellation::Sbas);
        assert_eq!(GnssSignal::new(0, Code::Bds3B1ci).to_constellation(), Constellation::Bds);
        assert_eq!(GnssSignal::new(0, Code::Bds3B1cq).to_constellation(), Constellation::Bds);
        assert_eq!(GnssSignal::new(0, Code::Bds3B1cx).to_constellation(), Constellation::Bds);
        assert_eq!(GnssSignal::new(0, Code::Bds3B5i).to_constellation(), Constellation::Bds);
        assert_eq!(GnssSignal::new(0, Code::Bds3B5q).to_constellation(), Constellation::Bds);
        assert_eq!(GnssSignal::new(0, Code::Bds3B5x).to_constellation(), Constellation::Bds);
        assert_eq!(GnssSignal::new(0, Code::Bds3B7i).to_constellation(), Constellation::Bds);
        assert_eq!(GnssSignal::new(0, Code::Bds3B7q).to_constellation(), Constellation::Bds);
        assert_eq!(GnssSignal::new(0, Code::Bds3B7x).to_constellation(), Constellation::Bds);
        assert_eq!(GnssSignal::new(0, Code::Bds3B3i).to_constellation(), Constellation::Bds);
        assert_eq!(GnssSignal::new(0, Code::Bds3B3q).to_constellation(), Constellation::Bds);
        assert_eq!(GnssSignal::new(0, Code::Bds3B3x).to_constellation(), Constellation::Bds);
        assert_eq!(GnssSignal::new(0, Code::GpsL1ci).to_constellation(), Constellation::Gps);
        assert_eq!(GnssSignal::new(0, Code::GpsL1cq).to_constellation(), Constellation::Gps);
        assert_eq!(GnssSignal::new(0, Code::GpsL1cx).to_constellation(), Constellation::Gps);
        assert_eq!(GnssSignal::new(0, Code::AuxGps).to_constellation(), Constellation::Gps);
        assert_eq!(GnssSignal::new(0, Code::AuxSbas).to_constellation(), Constellation::Sbas);
        assert_eq!(GnssSignal::new(0, Code::AuxGal).to_constellation(), Constellation::Gal);
        assert_eq!(GnssSignal::new(0, Code::AuxQzs).to_constellation(), Constellation::Qzs);
        assert_eq!(GnssSignal::new(0, Code::AuxBds).to_constellation(), Constellation::Bds);
    }
}